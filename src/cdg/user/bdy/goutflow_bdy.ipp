...
GOutflowBdy<TypePack>::GOutflowBdy(GOutflowBdy<TypePack>::Traits &traits) :
...
//**********************************************************************************
template<typename TypePack>
GOutflowBdy<TypePack>::~GOutflowBdy()
{
} // end, destructor
...
//**********************************************************************************
template<typename TypePack>
GBOOL GOutflowBdy<TypePack>::update_impl(
                              Grid      &grid,
                              StateInfo &stinfo,
                              Time      &time,
                              State     &utmp,
                              ...
                              State     &ub)
{
   GString    serr = "GOutflowBdy<TypePack>::update_impl: ";
   GINT       idstate, ind;
