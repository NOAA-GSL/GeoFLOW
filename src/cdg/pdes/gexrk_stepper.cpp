...
//**********************************************************************************
GExRKstepper::GExRKstepper(GSIZET iorder, GTVector)
:
iorder_               (iorder),
...
// RETURNS    : none.
//**********************************************************************************
void GExRKstepper::step(const GFTYPE &t, GTVector<GTVector<GFTYPE>> &uin,
                        GFTYPE &dt, GTVector<GTVector<GFTYPE>*> &tmp, 
                        GTVector<GTVector<GFTYPE>> &uout)
{
  ...
  GSIZET            i, j, n;
  GTVector<GFTYPE> *u     = tmp[iorder_-1] ; 
  GTVector<GFTYPE> *isum  = tmp[iorder_];    
  GTVector<GFTYPE> *alpha = &butcher_.alpha();
  GTMatrix<GFTYPE> *beta  = &butcher_.beta ();
  GTVector<GFTYPE> *c     = &butcher_.c    ();
