...
enum GStateCompType                    {GSC_KINETIC=0, GSC_MAGNETIC , GSC_DENSITYT , GSC_DENSITY1 , GSC_DENSITY2 , GSC_TEMPERATURE , GSC_PRESCRIBED , GSC_NONE };
const char * const sGStateCompType [] ={"GSC_KINETIC","GSC_MAGNETIC","GSC_DENSITYT","GSC_DENSITY1","GSC_DENSITY2","GSC_TEMPERATURE","GSC_PRESCRIBED","GSC_NONE"};
