...
enum GBdyType                    { GBDY_DIRICHLET=0 , GBDY_NOSLIP , GBDY_0FLUX , GBDY_PERIODIC , GBDY_OUTFLOW , GBDY_SPONGE , GBDY_NONE };
const char * const sGBdyType [] ={"GBDY_DIRICHLET"  ,"GBDY_NOSLIP","GBDY_0FLUX","GBDY_PERIODIC","GBDY_OUTFLOW","GBDY_SPONGE","GBDY_NONE"};
#endif
